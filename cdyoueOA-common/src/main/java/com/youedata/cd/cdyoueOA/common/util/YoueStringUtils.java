...
public class YoueStringUtils {
	...
	public static String getPercent(int num, double totalCount, String... objects) {
		...
		return YoueStringUtils.formatDoubleToString((num / totalCount) * 100, format) + "%";
	}
	 ...
	 * 
	 * @Title: setFlagAndMsg   
	 * @Description:设置flag和msg的值 
	 * @param modelMap
	 * @param flagDict
	 * @return ModelMap
	 */
	public static ModelMap setFlagAndMsg(ModelMap modelMap, FlagDict flagDict) {
	    modelMap.addAttribute("flag", flagDict.getV());
	    modelMap.addAttribute("msg", flagDict.getM());
        return modelMap;
    }
