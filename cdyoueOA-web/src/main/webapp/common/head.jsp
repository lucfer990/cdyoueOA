	...
	<div class="navbar-container" id="navbar-container">
		<div class="navbar-header pull-left">
			<a href="${basePath}/index.do">
				<img alt="成都优易" src="${basePath}/images/logo.png" height="45px">
			</a>
			<!-- /.brand -->
		</div>
		<!-- /.navbar-header -->
			...
			<ul class="nav ace-nav">
				...
				<li class="green"><a data-toggle="dropdown"
					...
					<ul
						...
						<li><a href="#"> <img
								src="${basePath}/images/avatars/avatar.png" class="msg-photo"
						...
						<li><a href="#"> <img
								src="${basePath}/images/avatars/avatar3.png" class="msg-photo"
						...
						<li><a href="#"> <img
								src="${basePath}/images/avatars/avatar4.png" class="msg-photo"
				...
				<li class="light-blue"><a data-toggle="dropdown" href="#"
					class="dropdown-toggle"> <img class="nav-user-photo"
						src="${basePath}/images/avatars/user.jpg" alt="Jason's Photo" />
						<span class="user-info"> <small>欢迎光临,</small> ${user.userName }
					...
					<ul
						...
						<li><a href="${basePath}/doLogout.do"> <i class="icon-off"></i> 退出
						</a></li>
					</ul></li>
			</ul>
			<!-- /.ace-nav -->
