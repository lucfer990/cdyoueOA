        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row col-xs-12">
                    ...
                    <div class="tabbable">
                        <!-- 标签名 -->
                        <ul class="nav nav-tabs" id="checkTaskTab">
                         <li class="active">
                            ...
                            <div id="tab1" class="tab-pane in active">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="ct_title" required="required" placeholder="任务名称"/>                                                    
                                                    
                                                </div>
                                                 <button id="ctsearch" class="btn btn-primary" type="button">
                                                    <i class="icon-search"></i>
                                                </button>                                                
                                                <button type="button" id="ctdetail" class="btn btn-success right">
                                ...
                                <div>
                                    <table id="dg_discountlist" data-toggle="table" data-toolbar="#toolbar"
                                           data-click-to-select="true" data-url="${basePath}/task/findCheckTask.do?status=1"
...
<script type="text/javascript" src="${basePath}/static/js/checktask.js"></script>
</body>
</html>