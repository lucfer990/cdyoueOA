        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="row col-xs-12">
                    ...
                    <div class="tabbable">
                        <!-- 标签名 -->
                        <ul class="nav nav-tabs" id="mytaskTab">
                            <li class="active">
                            ...
                            <div id="tab1" class="tab-pane in active">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="mytask_title" required="required" placeholder="任务名称"/>
                                                   <!--  <input type="text" class="form-control" id="mytask_startTime" required="required" placeholder="开始时间"/>
                                                    <input type="text" class="form-control" id="mytask_endTime" required="required" placeholder="结束时间"/>  -->
                                                </div>
                                                
                                                <button id="mtsearch" class="btn btn-primary" type="button">
                                                    <i class="icon-search"></i>
                                                </button>
                                                <button type="button" id="taskdetail" class="btn btn-success right">
                                                    <i class="icon-zoom-in"></i>任务详情
                                                </button>
                                                <button type="button" id="movetask" class="btn btn-warning right">
                                                  <i class="icon-cogs"></i>	任务交办
                                                </button>
                                                <button type="button" id="resolvetask" class="btn btn-info right">
                                                    <i class="icon-cogs"></i>任务分配
                                                </button>
                                                 <button type="button" id="alertmessage" class="btn btn-danger right">
                                                    <i class="icon-bookmark"><span id="msgNum"></span></i>新任务
                                                </button>                                                                                                                                                                                                                                     
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div>
                                    <table id="dg_discountlist" data-toggle="table" data-toolbar="#toolbar"
                                           data-click-to-select="true" data-url="${basePath}/task/findTask.do?status=1"
                                        ...
                                        <tr>
                                            ...
                                            <th data-field="alert" data-formatter="alertFmt">状态</th>
            ...
            <!-- 引入任务分配二级对话框界面 -->
                    <%@ include file="resolve_dialog.jsp" %>
             <!-- 引入任务详情二级对话框界面 -->       
                    <%@ include file="taskdetail_dialog.jsp" %>
                    <!-- 引入任务移交二级对话框界面 -->       
                    <%@ include file="movetask_dialog.jsp" %>
            <!-- /.page-content -->
        </div>
        <!-- /.main-content -->
...
<script type="text/javascript" src="${basePath}/static/js/mytask.js"></script>
</body>
</html>